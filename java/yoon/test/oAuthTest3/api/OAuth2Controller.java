...
public class OAuthController {
    ...
    public ResponseEntity<MemberResponse> kakaoAccessLogin(@RequestParam("access_token") String token, HttpServletResponse response){

        System.out.println(token);

        MemberResponse result = oAuthService.kakaoLogin(token, response);
